...
function removeCookie(cookie) {
  ...
  //chrome.cookies.set({"name":"locale","url":"http://www.ni.com","value":"en-CN","domain":"http://www.ni.com"});

  chrome.cookies.set({"name":"locale","url":"http://www.ni.com","value":"en-US","domain":".ni.com"},function (cookie){
  ...
  //chrome.cookies.set({"name":"locale","url":"http://.ni.com","value":"en-US","domain":"http://www.ni.com"});
...
*/
document.querySelector('#en-US').addEventListener('click', function() {changeLanguage("en-US", "US")}, false );

document.querySelector('#en-CN').addEventListener('click', function() {changeLanguage("en-CN", "EN")}, false );
document.querySelector('#zh-CN').addEventListener('click', function() {changeLanguage("zh-CN", "ZHS")}, false );

document.querySelector('#ja-JP').addEventListener('click', function() {changeLanguage("ja-JP", "JA")}, false );
document.querySelector('#en-JP').addEventListener('click', function() {changeLanguage("en-JP", "US")}, false );
...
window.onload = function() {
  sendAMessage();                                                                                                                
  var jp = document.getElementById('en-CN').onclick = sendAMessage;
  var en = document.getElementById('en-US').onclick = sendAMessage;
};*/
